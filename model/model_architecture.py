...
Based on the zoom_llm.ipynb implementation
"""
...
def create_coatnet_model(num_classes=36):
    """Create CoAtNet-1 model"""
    nums_blocks = [2, 2, 3, 5, 2]
    channels = [64, 96, 192, 384, 768]
    return MyCoAtNet(nums_blocks, channels, num_classes=num_classes)
